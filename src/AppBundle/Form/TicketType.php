...
class TicketType extends AbstractType
{
    ...
    {
        $builder->add('fechaCreado')->add('fechaStatus')->add('fechaCierre')->add('descripcionProblema')->add('categoria')->add('estado')->add('prioridad')->add('usuarioSolicitanteID')->add('usuarioAsignadoID')->add('titulo');
    }
